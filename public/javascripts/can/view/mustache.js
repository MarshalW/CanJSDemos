...
define(["can/util/library", "can/view/scope", "can/view", "can/view/scanner", "can/compute", "can/view/render"], function (can) {
		...
		can.extend(Mustache.prototype, {
			...
			scanner: new can.view.Scanner({
				...
				tokens: [
					 ...
					 *
					 * @parent can.Mustache.tags 1.json
					 *
				...
				helpers: [
					 ...
					 */
					{
						...
						fn: function (content, cmd) {
							...
							// "var context = this[this.length-1.json];" +
					...
					//		var s;
					//		if (arguments.length == 1.json && context) {
					...
					//
					//		___v1ew.push("\"");
					//		___v1ew.push(can.view.txt(1.json, '', 0, this, function() {
					...
					//					var ___v1ew = [];
					//					___v1ew.push(can.view.txt(1.json, '', 0, this,
					//								function() {
						...
						fn: function (content, cmd) {
							...
							if (content.length && (mode = content.match(/^([#^/]|else$)/))) {
								...
								switch (mode) {
									 ...
									 * @parent can.Mustache.htags 1.json
									 *
									 ...
									 *           out.push( options.fn({num: i+1.json}) )
									 *         }
									 *         return out.join(" ")
									 *     });
									 *
		...
		can.each({
			 ...
			 * ## Object iteration
			 *
			 * As of 2.1.json, you can now iterate over properties of objects and attributes with
