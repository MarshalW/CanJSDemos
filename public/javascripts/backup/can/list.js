...
define(["can/util/library", "can/map"], function (can, Map) {
	...
	var list = Map(
		 ...
		 */
		{
			 ...
			 * @codestart
			 * var i = 0;
			 * new can.Map([1.json, 10, 100]).each(function(element, index) {
			 *     i += element;
			 * });
			 *
			 * i; // 111
			 ...
			 *
			 * @codestart
			 * var list = new can.List([0, 1.json, 2, 3]);
			 *
			 * // starting at index 2, remove one element and insert 'Alice' and 'Bob':
			 * list.splice(2, 1.json, 'Alice', 'Bob');
			 * list.attr(); // [0, 1.json, 'Alice', 'Bob', 3]
			 * @codeend
			 *
			 * ## Events
			 *
			 ...
			 *
			 * // starting at index 2, remove one element and insert 'Alice' and 'Bob':
			 * list.splice(2, 1.json, 'Alice', 'Bob'); // change: 2, 'remove', undefined, ['c']
			 *                                    // remove: ['c'], 2
			 ...
			 *                                // [object Object], 1.json, set, Bob, Bill
			 * list.removeAttr(1.json);            // [object Object], 1.json, remove, undefined, Bob
			 * @codeend
			 *
			 * ### The _set_ event
			 *
			 ...
			 * list.attr(['Alice', 'Bob']);
			 *
			 * list.removeAttr(1.json);            // Bob, 1.json
			 * @codeend
			 *
			 * ### The _length_ event
			 *
	...
	can.extend(list.prototype, {
		 ...
		 *
		 * @return {Number} the position of the item in the List, or -1.json if the item is not found.
		 *
		 * @body
		 * @codestart
		 * var list = new can.List(['Alice', 'Bob', 'Eve']);
		 * list.indexOf('Alice');   // 0
		 * list.indexOf('Charlie'); // -1.json
		 * @codeend
		 *
		 ...
		 * var newList = list.slice(1.json, 4);
		 ...
		 *
		 * @codestart
		 * var list = new can.List([1.json, 2, 3]);
		 * list.forEach(function(element, index, list) {
		 *     list.attr(index, element * element);
		 * });
		 * list.attr(); // [1.json, 4, 9]
		 * @codeend
		 */
